...
const Winners = () => {
    ...
    return (
        <div
            className="text-center p-5 mt-24"
            style={{ fontFamily: "Bodoni Moda" }}
        >
            {/* WINNERS Heading with Gradient */}
            <h1 className="text-6xl font-bold bg-clip-text text-transparent text-white mb-32 md:text-8xl">
                WINNERS
            </h1>
            ...
            <div className="my-5 flex flex-wrap justify-center items-center]">
                <div className="m-2 flex flex-col items-center">
                    <h2
                        className="text-4xl font-bold bg-clip-text text-transparent text-white mt-20 mb-10"
                        style={{ fontFamily: "Bodoni Moda" }}
                    >
                        Volleyball
                    </h2>
